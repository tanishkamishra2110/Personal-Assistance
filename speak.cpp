...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE OUR USER|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE OUR USER";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="Tanishka")
        {
            ...
            do{
                ...
                else if(command=="play music")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    mciSendString("open \"C:\Users\tanmi\OneDrive\Desktop\project\speak\Taylor-Swift-Style-via-Naijafinix.com_.mp3\" type mpegvideo alias mp3", NULL, 0, NULL);
                ...
                else if(command=="open photo")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open","laptop.jpg",NULL, NULL, SW_NORMAL);
                }


                else if(command=="c++ book")
                {
                    cout<<"opening c++ book"<<endl;
                    string phrase = "opening c++ book";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open","C:\Users\tanmi\OneDrive\Desktop\project\speak\Beginning C++17, 5th Edition.pdf",NULL, NULL, SW_NORMAL);
                }
